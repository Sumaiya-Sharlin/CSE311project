...
<body>
   ...
   <h2 style="font-family: Arial,sans-serif; margin-left: 65px; color: #525252">List of Students:</h2>
      ...
      <?php 
         ...
         if($result -> num_rows > 0){
            while($row = $result-> fetch_assoc()){
               echo "<tr><td>". $row["name"] ."</td><td>". $row["id"] ."</td><td>". $row["curriculum"] ."</td><td>". $row["cred_completed"] ."</td></tr>";
            }
         echo "</table>";
      }
