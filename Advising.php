...
<body>
   ...
   <h2 style="font-family: Arial,sans-serif; margin-left: 65px; color: #525252">Available Sections:</h2>
      ...
      <?php 
         ...
         if($result -> num_rows > 0){
            while($row = $result-> fetch_assoc()){
               echo "<tr><td>". $row["course_id"] ."</td><td>". $row["sec_id"] ."</td><td>". $row["building"] ."</td><td>". $row["room_number"] ."</td>
                     <td>". $row["timeslot_id"] ."</td><td>". $row["time"] ."</td><td>". $row["Faculty_initial"] ."</td></tr>";
            }
         echo "</table>";
      }
