...
<body>
   ...
   <h2 style="font-family: Arial,sans-serif; margin-left: 65px; color: #525252">List of Faculty:</h2>
      ...
      <?php 
         ...
         if($result -> num_rows > 0){
            while($row = $result-> fetch_assoc()){
               echo "<tr><td>". $row["Faculty_initial"] ."</td><td>". $row["dept_id"] ."</td><td>". $row["name"] ."</td></tr>";
            }
         echo "</table>";
      }
