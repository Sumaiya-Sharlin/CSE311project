...
<body>
   ...
   <h2 style="font-family: Arial,sans-serif; margin-left: 65px; color: #525252">List of Courses:</h2>
      ...
      <?php 
         ...
         if($result -> num_rows > 0){
            while($row = $result-> fetch_assoc()){
               echo "<tr><td>". $row["course_id"] ."</td><td>". $row["dept_id"] ."</td><td>". $row["title"] ."</td><td>". $row["credits"] ."</td></tr>";
            }
         echo "</table>";
      }
